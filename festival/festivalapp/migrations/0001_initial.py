# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-31 20:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee_status', models.CharField(choices=[('ARRANGER', 'ARRANGER'), ('LYDTEKNIKER', 'LYDTEKNIKER'), ('LYSTEKNIKER', 'LYSTEKNIKER'), ('MANAGER', 'MANAGER'), ('BOOKINGANSVARLIG', 'BOOKINGANSVARLIG'), ('BOOKINGSJEF', 'BOOKINGSJEF'), ('MANAGER', 'PR-MANAGER'), ('SERVICE MANAGER', 'SERVICE MANAGER'), ('BAND MEMBER', 'BAND MEMBER')], max_length=32)),
