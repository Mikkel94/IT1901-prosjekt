# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-01 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specific_needs', models.TextField(default=b'No specific needs yet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee_status', models.CharField(choices=[(b'ARRANGER', b'ARRANGER'), (b'LYDTEKNIKER', b'LYDTEKNIKER'), (b'LYSTEKNIKER', b'LYSTEKNIKER'), (b'MANAGER', b'MANAGER'), (b'BOOKINGANSVARLIG', b'BOOKINGANSVARLIG'), (b'BOOKINGSJEF', b'BOOKINGSJEF'), (b'PR-MANAGER', b'PR-MANAGER'), (b'SERVICE MANAGER', b'SERVICE MANAGER'), (b'BAND MEMBER', b'BAND MEMBER')], max_length=32)),
